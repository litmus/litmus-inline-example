...
In general we aim to support the current and previous stable desktop releases of Chrome, and Firefox. We do similar with Microsoft's browsers, which at the time of writing means Edge. Litmus Inline and the main Litmus application do not support mobile browsers, though some features may work.

Due to recent changes around privacy and iframes within Safari, we're not currently able to fully support this browser at this time.
